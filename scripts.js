...
function renderResultRows(id,rows,meta={}){
  const el=document.getElementById(id);if(!el)return;
  if(!rows.length){resultReportCache[id]=null;el.innerHTML='<div class="muted">No result records found for this selection.</div>';return;}
  const title=meta.title||'Students Result Report',subtitle=meta.subtitle||'',filters=meta.filters||{};
  resultReportCache[id]={type:'rows',title,subtitle,filters,rows,individual:!!filters.UIN};
  el.innerHTML=`<div class="report-header"><div><h3 style="margin:0">${escapeHtml(title)}</h3>${subtitle?`<div class="muted" style="margin-top:4px">${escapeHtml(subtitle)}</div>`:''}<div class="report-filter-line">${Object.entries(filters).map(([k,v])=>`<span><b>${escapeHtml(k)}:</b> ${escapeHtml(v||'—')}</span>`).join('')}</div></div>${resultPdfActions(id)}</div><div class="table-wrap"><table class="data-table"><thead><tr><th>Branch</th><th>UIN</th><th>Student Name</th><th>Father's Name</th><th>Exam</th><th>Date</th><th>Category</th><th>Class</th><th>Batch</th><th>Total</th><th>Percentage</th><th>Rank</th><th>Status</th></tr></thead><tbody>${rows.map(r=>`<tr><td>${escapeHtml(r.Branch_Name||'')}</td><td><b>${escapeHtml(r.UIN||'')}</b></td><td>${escapeHtml(r.Student_Name||'')}</td><td>${escapeHtml(r.Father_Name||'')}</td><td>${escapeHtml(r.Exam_Name||'')}</td><td>${escapeHtml(String(r.Exam_Date||'').slice(0,10))}</td><td>${escapeHtml(r.Category_Name||'')}</td><td>${escapeHtml(r.Class_Name||'')}</td><td>${escapeHtml(r.Batch_Code||'')}</td><td>${escapeHtml(r.Total_Obtained_Marks??r.Total_Marks??'')} / ${escapeHtml(r.Total_Max_Marks??r.Max_Total_Marks??'')}</td><td><b>${escapeHtml(resultPercentageText_(r.Percentage))}</b></td><td>${escapeHtml(r.Rank||'—')}</td><td>${escapeHtml(r.Result_Status||'')}</td></tr>`).join('')}</tbody></table></div>`}
...
function saveResultReportAsPdf(id){const report=resultReportCache[id];if(!report){showToast('Generate a report first.');return;}const w=window.open('','_blank');if(!w){showToast('Please allow pop-ups to print the report.');return;}w.document.write(buildPrintableResultHtml(report));w.document.close();w.focus();setTimeout(()=>w.print(),400);}
...
function buildPrintableResultHtml(report){
  const filters=Object.entries(report.filters||{}).map(([k,v])=>`<span style="margin-right:18px"><b>${escapeHtml(k)}:</b> ${escapeHtml(v||'—')}</span>`).join('');
  const details=report.type==='rows'?report.rows:(report.details||[]),agg=report.type==='summary'?(report.summary?.rows||[]):[];
  const individual=report.type==='rows'&&!!(report.individual||report.filters?.UIN),identity=individual&&details.length?details[0]:null;
  const identityUin=identity?.UIN||report.filters?.UIN||'',identityStudent=identity?.Student_Name||'',identityFather=identity?.Father_Name||'';
  const safeFileBase=individual?[identityUin,identityStudent,identityFather].map(resultReportFilenamePart_).filter(Boolean).join('_'):resultReportFilenamePart_(report.title||'AJMAL_Result_Report');
  const logoData='data:image/png;base64,';
  const detailRows=details.map(r=>`<tr>${individual?'':`<td>${escapeHtml(r.UIN||'')}</td><td>${escapeHtml(r.Student_Name||'')}</td><td>${escapeHtml(r.Father_Name||'')}</td>`}<td>${escapeHtml(r.Exam_Name||'')}</td><td>${escapeHtml(String(r.Exam_Date||'').slice(0,10))}</td><td>${escapeHtml(r.Category_Name||'')}</td><td>${escapeHtml(r.Class_Name||'')}</td><td>${escapeHtml(r.Batch_Code||'')}</td><td>${escapeHtml(r.Physics_Marks??'')}</td><td>${escapeHtml(r.Chemistry_Marks??'')}</td><td>${escapeHtml(r.Botany_Marks??'')}</td><td>${escapeHtml(r.Zoology_Marks??'')}</td><td>${escapeHtml(r.Maths_Marks??'')}</td><td>${escapeHtml(r.Total_Obtained_Marks??r.Total_Marks??'')} / ${escapeHtml(r.Total_Max_Marks??r.Max_Total_Marks??'')}</td><td>${escapeHtml(resultPercentageText_(r.Percentage))}</td><td>${escapeHtml(r.Rank||'—')}</td><td>${escapeHtml(r.Result_Status||'')}</td></tr>`).join('');
  const resultHeaders=individual?'<th>Exam</th><th>Date</th><th>Category</th><th>Class</th><th>Batch</th><th>Physics</th><th>Chemistry</th><th>Botany</th><th>Zoology</th><th>Maths</th><th>Total Obtained / Max</th><th>Percentage</th><th>Rank</th><th>Status</th>':'<th>UIN</th><th>Student Name</th><th>Father\'s Name</th><th>Exam</th><th>Date</th><th>Category</th><th>Class</th><th>Batch</th><th>Physics</th><th>Chemistry</th><th>Botany</th><th>Zoology</th><th>Maths</th><th>Total Obtained / Max</th><th>Percentage</th><th>Rank</th><th>Status</th>';
  const identityHtml=identity?`<div class="identity-table-wrap"><table class="identity-table"><thead><tr><th>UIN</th><th>Student Name</th><th>Father's Name</th></tr></thead><tbody><tr><td><b>${escapeHtml(identityUin)}</b></td><td>${escapeHtml(identityStudent)}</td><td>${escapeHtml(identityFather)}</td></tr></tbody></table></div>`:'';
  return `<!doctype html><html><head><meta charset="utf-8"><title>${escapeHtml(safeFileBase||'AJMAL_Result_Report')}</title><style>@page{size:A4 landscape;margin:12mm 10mm 10mm}body{font-family:Arial,sans-serif;color:#172033;font-size:9px;padding-top:28mm}.print-brand{position:fixed;top:0;left:0;right:0;height:24mm;display:flex;justify-content:center;align-items:flex-start;background:#fff}.print-brand img{width:110mm;max-height:18mm;object-fit:contain}.identity-table,.table{width:100%;border-collapse:collapse}.identity-table{margin:10px 0 12px}.identity-table th,.identity-table td,.table th,.table td{border:1px solid #cfd7e3;padding:5px;text-align:left}.identity-table th{background:#0b2f63;color:#fff}.table th{background:#1f4e78;color:#fff}h1{color:#0b2f63;font-size:18px}.sub{color:#5d6b82;margin:4px 0 8px}.filters{margin:8px 0;padding:7px;border:1px solid #dbe3ee;background:#f6f9fc}.footer-note{margin-top:10px;color:#6b7280;font-size:9px}</style></head><body><div class="print-brand"><img src="${logoData}" alt="AJMAL SUPER 40"></div><h1>Student Result Report</h1><div class="sub">AJMAL SUPER 40 • Academic Performance Report</div>${individual?'':`<div class="filters">${filters||'All Records'}</div>`}${identityHtml}<table class="table small"><thead><tr>${resultHeaders}</tr></thead><tbody>${detailRows||`<tr><td colspan="${individual?14:17}">No detailed student result records available.</td></tr>`}</tbody></table><div class="footer-note">Generated from AJMAL SUPER 40 Student Operations ERP</div></body></html>`;
}
